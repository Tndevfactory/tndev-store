...
<h1 class="fs-3 mt-1 text-capitalize">create Subcategory </h1>


<form  method="POST" action="{{ route('admin-subcategory-store', App::getLocale()) }}"
class="row g-3 row-cols-1 row-cols-md-6 needs-validation mt-md-3" novalidate>
  ...
  <div class="col">
   ...
   <input type="text" class="form-control mb-2  @error('dename') 'is-invalid' @enderror "
        name="dename" value="{{ old('dename')  }}" required>
  ...
  <div class="col col-md-12">
    <button type="submit" class="btn btn-primary">Store subCategory</button>
  </div>
