...
<!-- left side vendeur    --><x-offcanvas></x-offcanvas>
 <ul class="list-unstyled text-white  mt-3">
                <li class=" text-white fs-3 mt-1">Profil vendeur </li>
                ...
                <li class=" text-white  mt-1"> <a href="#" class="text-decoration-none">Manage Products</a></li>
